export class TimelineEvent {
  constructor({
    ...
    financialType = 'gasto', // 'entrada' | 'gasto' | 'investimento' | 'amortizacao'
    periodicity = 'recorrente', // 'recorrente' | 'unico' | 'periodo'
    recurrenceEndDate = null,
    endDate = null,
    status = 'Pendente', // 'Pago' | 'Recebido' | 'Investido' | 'Pendente' | 'Atrasada' | 'Planeado' | 'Concluído'
    ...
    this.notes = notes;
    this.isIncome = Boolean(isIncome);
    this.isExpense = Boolean(isExpense);
    this.isInvestment = Boolean(isInvestment);
    this.isAmortization = Boolean(isAmortization || category === 'amortizacao' || financialType === 'amortizacao');
