export const translations = {
  en: {
    ...
    timeline: {
      ...
      forecast: "Forecast",
      today: "Today",
      monthProjection: "Planned",
      realProjection: "Settled",
      monthProgressTitle: "{{percent}}% of the planned amount realized",
      notComputed: "Not computed",
      notComputedTooltip: "Events from this month are before the configured starting period (Compute From) and do not affect the accumulated balance.",
      selectProjectionMode: "Select calculation mode",
      ...
      monthRealizedIncomeTitle: "Total realized/received income for this month",
      monthRealizedExpenseTitle: "Total realized/paid expenses for this month",
      monthRealizedInvestmentTitle: "Total realized/invested contributions for this month",
      monthRealizedLoanTitle: "Total realized loan installments/amortizations paid this month",
      monthRealizedBalanceTitle: "Realized monthly balance = Realized Income - (Realized Expenses + Realized Investments)",
      balance: "Balance",
      ...
      noEventsFoundUpToCurrentMonth: "No events found up to the current month",
      noEventsFoundAdjustFiltersDesc: "Try adjusting search filters in the sidebar.",
    ...
    loanCard: {
      ...
      stampTax: "Charged Fees",
      lateFee: "Late Fee",
      remainingDebt: "Remaining Debt",
      amortizedValue: "Amortized Amount",
      purpose: "Purpose:",
      remainingBalanceAfter: "Balance After:",
    ...
    timeboardModal: {
      ...
      condoNameLabel: "Condo Name",
      condoNamePlaceholder: "e.g., Condomínio Residencial, Condomínio Comercial...",
    ...
    timeboardSettings: {
      ...
      entities: {
        ...
        table: {
          entity: "Person Name / Entity",
          type: "Type",
          role: "Role",
          contact: "Contact (Email / Phone)",
          obligatorIdentification: "Obligator Identification",
        ...
        form: {
          ...
          personNamePlaceholder: "e.g., John Doe or Tech Solutions Ltd",
          namePlaceholder: "e.g., John Doe or Tech Solutions Ltd",
          obligatorIdentificationLabel: "Obligator Identification *",
          obligatorIdentificationPlaceholder: "e.g., NIF, CPF or ID Document",
          emailLabel: "Email Address",
    ...
    loanModal: {
      ...
      tanRateLabel: "TAN Rate (%)",
      spreadLabel: "Spread (%)",
      interestStampTaxRateLabel: "Charged Fees (€)",
    ...
    loanHeader: {
      ...
      editContractTitle: "Edit contract parameters (TAN, Spread, Financed Capital, Charged Fees, etc.)",
    ...
    incomeHeader: {
      ...
      projectedAccumulationLabel: "Planned ({year}):",
      ...
      monthVsPrevMonth: "This month vs previous month:",
      annualIncomingLabel: "Annual Income (12m):",
    ...
    withdrawalModal: {
      ...
      subtitle: "Pocket balance withdrawal",
      pocketLabel: "Pocket *",
      ...
      dayLabel: "Due Day *",
      titleLabel: "Title / Description *",
      titlePlaceholder: "Ex: Emergency withdrawal, planned purchase...",
    ...
    investmentHeader: {
      ...
      annualTarget: "of {amount} annual total",
      currentTitle: "CURRENT",
      receivedTotalLabel: "Contributed:",
      targetLabel: "Target:",
      targetReached: "{percent}% of target reached",
      next30DaysTitle: "NEXT 30 DAYS",
      projected30dLabel: "Projected 30d:",
    ...
    balanceHeader: {
      ...
      computeBtnTitle: "Click to change and save the initial computation month for Balance",
      ...
      periodIncomeBreakdown: "PERIOD INCOME BREAKDOWN",
      noProjectedIncome: "No projected income",
      ...
      plusMonths: "+{count} Months",
      plusYear: "+{count} Year",
      plusYears: "+{count} Years",
      today: "Today ({month})",
      projectToTitle: "Project up to {date}",
      projectedBalance: "Projected Balance",
      forecastInflows: "Forecast Inflows:",
      forecastOutflows: "Forecast Outflows:",
      forecastSavings: "Forecast Savings:",
      withdrawals: "withdrawals",
      incomeTag: "income",
      initialBalance: "incl. {amount} initial",
      investments: "Investments:",
      computeModalTitle: "Compute starting from",
      computeModalDescription: "Set the starting month/year for calculating Balance summaries and charts.",
    ...
    diaryModal: {
      ...
      titleRequired: "Please enter the entry title.",
      dateRequired: "Please choose the entry day.",
      notFound: "Diary entry not found.",
  ...
  pt: {
    ...
    timeline: {
      ...
      forecast: "Previsão",
      today: "Hoje",
      monthProjection: "Planejado",
      realProjection: "Efetivado",
      monthProgressTitle: "{{percent}}% realizado do planeado",
      notComputed: "Não computado",
      notComputedTooltip: "Os eventos deste mês são anteriores ao marco inicial configurado (Compute From) e não afetam a acumulação do saldo.",
      selectProjectionMode: "Selecionar modo de cálculo",
      ...
      monthRealizedIncomeTitle: "Total de entradas realizadas/recebidas neste mês",
      monthRealizedExpenseTitle: "Total de gastos realizados/pagos neste mês",
      monthRealizedInvestmentTitle: "Total de investimentos realizados neste mês",
      monthRealizedLoanTitle: "Total de prestações/amortizações pagas neste mês",
      monthRealizedBalanceTitle: "Saldo Realizado do mês = Entradas Realizadas - (Gastos Realizados + Investimentos Realizados)",
      balance: "Saldo",
      ...
      noEventsFoundUpToCurrentMonth: "Nenhum evento encontrado até o mês corrente",
      noEventsFoundAdjustFiltersDesc: "Tente alterar os filtros de pesquisa na barra lateral.",
    ...
    loanCard: {
      ...
      stampTax: "Taxas Cobradas",
      lateFee: "Mora / Atraso",
      remainingDebt: "Saldo Devedor",
      amortizedValue: "Valor Amortizado",
      purpose: "Finalidade:",
      remainingBalanceAfter: "Saldo Devedor Após:",
      reduceInstallment: "Redução da Parcela",
    ...
    timeboardSettings: {
      ...
      entities: {
        ...
        table: {
          entity: "Nome da Pessoa / Entidade",
          type: "Tipo",
          role: "Função (Role)",
          contact: "Contacto (Email / Tel)",
          obligatorIdentification: "Identificação do Obrigado",
        ...
        form: {
          ...
          personNamePlaceholder: "Ex: Maria Silva ou Empresa XYZ Lda",
          namePlaceholder: "Ex: Maria Silva ou Empresa XYZ Lda",
          obligatorIdentificationLabel: "Identificação do Obrigado *",
          obligatorIdentificationPlaceholder: "Ex: NIF, CPF, BI ou Cartão de Cidadão",
          emailLabel: "Endereço de Email",
          emailPlaceholder: "Ex: utilizador@exemplo.com",
          phoneLabel: "Contacto Telefónico (Opcional)",
    ...
    loanModal: {
      ...
      spreadLabel: "Spread (%)",
      interestStampTaxRateLabel: "Taxas Cobradas (€)",
    ...
    loanHeader: {
      ...
      editContractTitle: "Editar os parâmetros do contrato (TAN, Spread, Montante Financiado, Taxas Cobradas, etc.)",
    ...
    incomeHeader: {
      ...
      projectedAccumulationLabel: "Planejado ({year}):",
      ...
      monthVsPrevMonth: "Este mês vs mês anterior:",
      annualIncomingLabel: "Renda Anual (12m):",
      annualProjectionLabel: "Projeção 12M+:",
      chartTitle: "EVOLUÇÃO DO VOLUME DE RENDIMENTOS (ÚLTIMOS 6 MESES + MÊS ATUAL)",
      summaryView: "Resumo",
    ...
    withdrawalModal: {
      ...
      subtitle: "Resgate de saldo do cofrinho",
      pocketLabel: "Cofrinho *",
      ...
      titleLabel: "Título / Descrição *",
      titlePlaceholder: "Ex: Resgate de emergência, compra planejada...",
    ...
    investmentHeader: {
      ...
      annualTarget: "de {amount} totais anuais",
      currentTitle: "ATUAL",
      receivedTotalLabel: "Aportado:",
      targetLabel: "Target:",
      targetReached: "{percent}% do target atingido",
      next30DaysTitle: "PRÓXIMOS 30 DIAS",
      projected30dLabel: "Previstos 30d:",
    ...
    balanceHeader: {
      ...
      settingsTitle: "Definições da Timeline",
      computeLabel: "Computar:",
      computeBtnTitle: "Clique para alterar e salvar o mês inicial de computação do Balanço",
      ...
      periodIncomeBreakdown: "DISTRIBUIÇÃO DE RENDIMENTOS DO PERÍODO",
      noProjectedIncome: "Sem rendimentos projetados",
      ...
      inAccountLegend: "Poupado",
      dueLegend: "Devido",
      availableLegend: "Disponível",
      loansAndFinancing: "EMPRÉSTIMOS E FINANCIAMENTOS",
      amortizedCapital: "Capital Amortizado",
      debtCapital: "Capital Devido",
      ...
      incomeTag: "entradas",
      initialBalance: "incl. {amount} inicial",
      investments: "Investimentos:",
    ...
    diaryModal: {
      ...
      titleRequired: "Por favor, insira o título do registro.",
      dateRequired: "Por favor, escolha o dia do registro.",
      notFound: "Registro do diário não encontrado.",
